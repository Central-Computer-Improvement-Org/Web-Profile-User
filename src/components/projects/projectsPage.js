...
const ProjectPage = () => {
   ...
   // //     projectData = projectData.slice(start, end);
   // //   }
            ...
            <section className="xl:px-[179px] lg:px-[50px] md:px-[80px] px-[20px]">
               <div className="flex flex-wrap lg:gap-[36px] gap-[2px] justify-center ">
                  {divisions.map((data, index) => (
                     <div
                        key={index}
                        className={`lg:px-[30px] md:px-[20px] px-[10px] lg:py-[10px] md:py-[8px] py-[5px] ${menuActive.name == data.name
                     ...
                     >
                        <h1
                           className={`lg:text-[24px] md:text-[18px] text-[15px] ${menuActive.name == data.name
