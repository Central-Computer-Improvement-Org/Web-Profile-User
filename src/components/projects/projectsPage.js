            ...
            <section className="xl:px-[179px] lg:px-[50px] md:px-[80px] px-[20px]">
               <div className="flex flex-wrap lg:gap-[36px] gap-[2px] justify-center ">
                  {ProjectMenus.map((data, index) => (
                     <div
                        key={index}
                        className={`lg:px-[30px] md:px-[20px] px-[10px] lg:py-[10px] md:py-[8px] py-[5px] ${menuActive == data.menu
                     ...
                     >
                        <h1
                           className={`lg:text-[24px] md:text-[18px] text-[15px] ${menuActive == data.menu
