...
const ProjectDataSecond = () => {
    ...
    return (
        <>
            <div className="relative flex flex-col items-center justify-between w-full h-auto space-y-10 bg-gray-200">
                <div className="absolute bottom-0 h-[70%] w-full bg-bluePallete-700 rounded-t-lg"></div>
                {/* Project Thumbnail */}
