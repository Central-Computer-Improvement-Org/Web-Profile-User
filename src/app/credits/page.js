...
export default function Credits() {
  const presidentDatas = [
    { posisition: 'Ketua Devisi', name: 'Kenzo Tiyu' },
    { posisition: 'Ketua Devisi', name: 'Kenzo Tiyu' },
  ];
  const crewDatas = [
        ...
        <section className="">
          ...
          <div className="flex xl:gap-[40px] md:gap-[30px] gap-[16px] md:flex-row flex-col justify-center items-center">
            {presidentDatas.map((data, index) => (
              <div
                key={index}
                className="xl:w-[534px] xl:h-[286px] lg:w-[380px] lg:h-[186px] md:w-[334px] md:h-[186px] w-[257px] h-[152px] rounded-[15px] bg-greenPallete-300 flex justify-center items-center "
              >
                <div className="w-full flex xl:gap-[40px] md:gap-[10px] lg:px-[24px] md:px-[16px] px-[8] ">
                  <div className=" grow flex flex-col">
                    <div className="grow">
                      <p className="xl:text-[20px] md:text-[16px] text-[15px] font-medium text-bluePallete-800">
                        {data.posisition}
                      </p>
                      <h1 className="xl:text-[40px] md:text-[28px] text-[25px] font-black text-bluePallete-800">
                        {data.name}
                      </h1>
                    </div>
        ...
        <section className="">
          ...
          <div className="flex xl:gap-[40px] md:gap-[30px] gap-[16px] md:flex-row flex-col justify-center items-center">
            {presidentDatas.map((data, index) => (
              <div
                key={index}
                className="xl:w-[534px] xl:h-[286px] md:w-[334px] md:h-[186px] w-[257px] h-[152px] rounded-[15px] bg-greenPallete-300 flex justify-center items-center px-[16px]"
              >
                <div className="flex xl:gap-[40px] md:gap-[10px] ">
